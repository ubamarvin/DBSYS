...
public class Studiengang {
	...
	public boolean save() throws PersistentException {
		try {
			Datenbanksysteme2PersistentManager.instance().saveObject(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete() throws PersistentException {
		try {
			Datenbanksysteme2PersistentManager.instance().deleteObject(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh() throws PersistentException {
		try {
			Datenbanksysteme2PersistentManager.instance().getSession().refresh(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict() throws PersistentException {
		try {
			Datenbanksysteme2PersistentManager.instance().getSession().evict(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean deleteAndDissociate()throws PersistentException {
		try {
			Vorlesung[] l_vorlesungs = _vorlesung.toArray();
	...
	private java.util.Set this_getSet (int key) {
		if (key == ORMConstants.KEY_STUDIENGANG__VORLESUNG) {
	...
	public final VorlesungSetCollection _vorlesung = new VorlesungSetCollection(this, _ormAdapter, ORMConstants.KEY_STUDIENGANG__VORLESUNG, ORMConstants.KEY_VORLESUNG__STUDIENGANG, ORMConstants.KEY_MUL_ONE_TO_MANY);
