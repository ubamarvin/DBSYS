...
public class Datenbanksysteme2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Datenbanksysteme2";
	...
	private Datenbanksysteme2PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Datenbanksysteme2PersistentManager();
		}
